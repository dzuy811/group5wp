                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col d-flex justify-content-center">
                          <select name="seats[STA]" id="seats-STA" class="btn btn-info dropdown-toggle " <?php if(isset($_POST['movie']['id'])&& $_POST['movie']['id']!=""){ echo 'onchange="calPrice();"';} ?>>
                            ...
                            <?php for ($i=1; $i <=10 ; $i++) { ?>
                              <option value="<?=$i?>"   <?php if(isset($_POST['seats']['STA']) && $_POST['seats']['STA'] ==$i){ echo 'selected';} ?>  ><?=$i?></option>
                            <?php }?>                            
                          </select>
                        </div>
                      </div>
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col d-flex justify-content-center">
                          <select name="seats[STP]" id="seats-STP" class="btn btn-info dropdown-toggle" <?php if(isset($_POST['movie']['id'])&& $_POST['movie']['id']!=""){ echo 'onchange="calPrice();"';} ?>>
                            <option value="0">Please Select</option>
                            <?php for ($i=1; $i <=10 ; $i++) { ?>
                              <option value="<?=$i?>"   <?php if(isset($_POST['seats']['STP']) && $_POST['seats']['STP'] ==$i){ echo 'selected';} ?>  ><?=$i?></option>
                            <?php }?>   
                          </select>
                        </div>
                      </div>
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col d-flex justify-content-center">
                          <select name="seats[STC]" id="seats-STC" class="btn btn-info dropdown-toggle" <?php if(isset($_POST['movie']['id'])&& $_POST['movie']['id']!=""){ echo 'onchange="calPrice();"';} ?>>
                            <option value="0">Please Select</option>
                            <?php for ($i=1; $i <=10 ; $i++) { ?>
                              <option value="<?=$i?>"   <?php if(isset($_POST['seats']['STC']) && $_POST['seats']['STC'] ==$i){ echo 'selected';} ?>  ><?=$i?></option>
                            <?php }?>
                          </select>
                        </div>
                      </div>
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col d-flex justify-content-center">
                          <select name="seats[FCA]" id="seats-FCA" class="btn btn-info dropdown-toggle" <?php if(isset($_POST['movie']['id'])&& $_POST['movie']['id']!=""){ echo 'onchange="calPrice();"';} ?>>
                            <option value="0">Please Select</option>
                            <?php for ($i=1; $i <=10 ; $i++) { ?>
                              <option value="<?=$i?>"   <?php if(isset($_POST['seats']['FCA']) && $_POST['seats']['FCA'] ==$i){ echo 'selected';} ?>  ><?=$i?></option>
                            <?php }?>   
                          </select>
                        </div>
                      </div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <div
                      ...
                      <input type="text" id="total-input" value="<?= isset($_POST['total_input']) ?  '$ '.$_POST['total_input'] :""?>" name="total_input" class="d-none">
